...
- Current delivery target: `v0.10.2`
- Pre-soak hardening: `v0.10.2` establishes trustworthy evidence with CI,
  web typechecking, automatic test discovery, Docker-context hygiene, and idle
  observation of scheduler-started runs. Integrity and execution patches must
  land before enabling the scheduler.
