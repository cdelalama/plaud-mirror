...
- Current delivery target: `v0.12.0`
- Deployed runtime before this rollout: `v0.11.2`
...
- Current phase: **Phase 6 entered at `0.11.0`; Phase 3 exit gate (post-deploy multi-day scheduler evidence plus live webhook drill) remains pending and independent**
...
| Phase 6 | `0.11.x`+ | Operator and OSS fit and finish: explicit destructive workflows, public quickstart, sanitized examples, contributor-facing polish | Hosted or multi-tenant posture | Operator workflows are deliberate and the repo is understandable without private infra context |
