...
- Current delivery target: `v0.10.8`
- Deployed runtime: `v0.10.7` during the soak; `v0.10.8` is governance-only
...
- Current phase: **Phase 5 - infra/protocol integration entered at `0.10.0`; Phase 3 exit gate (five-day scheduler soak plus live webhook drill) still pending**
