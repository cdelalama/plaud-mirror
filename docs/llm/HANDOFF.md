...
0. ~~Arm operator access control~~ — DONE 2026-06-11 (see Open Work). New top action: re-validate the Plaud bearer token from the panel — `auth.state` has been `degraded` (HTTP 403) since 2026-05-13; nothing can sync until it is replaced.
